...
function nicen_theme_load_source()
{
  ...
  /*
	 * 内联的css
	 * */
  wp_add_inline_style("main-styles", vsprintf(
    '.personal{--theme-color:%s;--theme-header-bg-color:%s;--theme-header-font-color:%s;--theme-sub-menu-bg-color:%s;--theme-sub-menu-font-color:%s;--theme-header-border-color:%s;--theme-header-shadow-color:%s;--theme-footer-bg-color: %s;--theme-footer-font-color: %s;}',
    [
